...
def md5(message):
    ...
    for i in range(0, len(message), 64):
        block = message
        words = [int.from_bytes(block[j:j+4], byteorder='little') for j in range(i, i+64, 4)]
        a0, b0, c0, d0 = a, b, c, d
        ...
        for j in range(64):
            ...
            d = c
            c = b
            b = b + left_rortate((a + f + 0x5A827999 + words[g]) & 0xFFFFFFFF, 3)
            a = temp
